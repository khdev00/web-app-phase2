...
const metric_calcs_1 = require("./run_URL_FILE/metric_calcs");
const metric_calcs_helpers_1 = require("./run_URL_FILE/metric_calcs_helpers");
test('no key', () => __awaiter(void 0, void 0, void 0, function* () {
    // Set up the test environment to not have the GITHUB_TOKEN
    delete process.env.GITHUB_TOKEN;
    try {
        yield retrieveGithubKey();
    }
    catch (error) {
        expect(() => { throw error; }).toThrowError("GitHub API key not found in environment variables.");
    }
}));
test('valid token', () => __awaiter(void 0, void 0, void 0, function* () {
    process.env.GITHUB_TOKEN = 'valid_token';
    const token = yield retrieveGithubKey();
    expect(token).toBe('valid_token');
}));
test('getPackageObject with valid owner, package name, and token', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    packageObj = yield getPackageObject(owner, packageName, token, packageObj);
    expect(packageObj.contributors.contributor1).toEqual(undefined);
    expect(packageObj.readmeLength).toBe(-1);
}));
test('getPackageObject with invalid owner and package name', () => __awaiter(void 0, void 0, void 0, function* () {
...
test('calculateBusFactor should calculate bus factor correctly for a long readme and multiple contributors', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const busFactor = yield (0, metric_calcs_1.calculateBusFactor)(readmeLength, contributors);
...
test('calculateBusFactor should handle a short readme and few contributors', () => __awaiter(void 0, void 0, void 0, function* () {
...
test('calculateBusFactor should handle a very long readme and many contributors', () => __awaiter(void 0, void 0, void 0, function* () {
...
test('calculateBusFactor should handle an empty readme and one contributor', () => __awaiter(void 0, void 0, void 0, function* () {
    // Mock data for an empty readme and one contributor
    const readmeLength = 0; // An empty readme
    const contributors = new Map([['contributor1', 10]]);
    // Mock Axios responses for the required calls inside calculateBusFactor
    axios.get.mockResolvedValueOnce({
...
test('calculateBusFactor for over 20 contributors', () => __awaiter(void 0, void 0, void 0, function* () {
...
test('calculateRampUp with target readme length', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const rampUp = yield (0, metric_calcs_1.calculateRampUp)(targetReadmeLength);
    expect(rampUp).toBeCloseTo(1, 2);
}));
test('calculateRampUp with no readme', () => __awaiter(void 0, void 0, void 0, function* () {
    // Mock the Axios response for the README content
    axios.get.mockResolvedValue({ data: Buffer.from('Readme content', 'utf-8').toString('base64') });
    const readmeLength = 0;
    const rampUp = yield (0, metric_calcs_1.calculateRampUp)(readmeLength);
    expect(rampUp).toBeCloseTo(0.67500, 2);
}));
test('calculateRampUp with longestReadmeLength', () => __awaiter(void 0, void 0, void 0, function* () {
    // Mock the Axios response for the README content
    axios.get.mockResolvedValue({ data: Buffer.from('Readme content', 'utf-8').toString('base64') });
...
test('calculateRampUp with arbitrary readme length', () => __awaiter(void 0, void 0, void 0, function* () {
    // Mock the Axios response for the README content
    axios.get.mockResolvedValue({ data: Buffer.from('Readme content', 'utf-8').toString('base64') });
...
describe('getGithubDetailsFromNpm', () => {
    ...
    it('should return GitHub details when a valid npm package URL is provided', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const result = yield getGithubDetailsFromNpm(npmUrl);
    ...
    it('should return null when an error occurs during the request', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should return null when the GitHub URL is not present', () => __awaiter(void 0, void 0, void 0, function* () {
...
describe('calculateAllMetrics', () => {
    it('should calculate metrocs for all URLs', () => __awaiter(void 0, void 0, void 0, function* () {
        let urlObj = new Url;
        let urlObjs = [urlObj];
        const githubToken = 'your-github-token';
        axios.get.mockResolvedValue({ data: Buffer.from('Readme content', 'utf-8').toString('base64') });
        const packageObj = yield calculateAllMetrics(urlObjs);
...
describe('fetchUrlsFromFile', () => {
    ...
    it('should parse valid URLs from the file', () => __awaiter(void 0, void 0, void 0, function* () {
        const urls = yield fetchUrlsFromFile(sampleFilePath);
        expect(urls).toEqual([
            {
                "packageName": "express",
                "packageOwner": null,
...
describe('readReadmeFile', () => {
    it('should read the content of an existing README file', () => __awaiter(void 0, void 0, void 0, function* () {
        // Create a spy for fs.existsSync and make it return true
        const existsSpy = jest.spyOn(fs_1.default, 'existsSync');
        ...
        const readmeContent = yield (0, metric_calcs_helpers_1.readReadmeFile)(cloneDir);
    ...
    it('should return an empty string for a non-existing README file', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should handle errors when reading the README file', () => __awaiter(void 0, void 0, void 0, function* () {
        // Create a spy for fs.existsSync and make it return true
        const existsSpy = jest.spyOn(fs_1.default, 'existsSync');
        existsSpy.mockReturnValue(true);
