        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    searchUrl = "https://api.github.com/search/issues?q=".concat(encodeURIComponent(searchQuery), "&per_page=20");
                ...
                case 8:
                    _i++;
                    return [3 /*break*/, 3];
                case 9: return [2 /*return*/, (totalLOC === 0) ? 0 : reviewedLOC / totalLOC];
                case 10:
                    error_2 = _b.sent();
...
function getAllPages(url, headers) {
    return __awaiter(this, void 0, void 0, function () {
        var responseData, page, response, linkHeader;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    responseData = [];
